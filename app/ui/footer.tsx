...
export default async function Footer({ locale }: { locale: string }) {
    ...
    return (
        <footer className="w-full bg-slate-800 text-white py-4 mt-6 text-sm">
            <div className="container max-w-screen-xl flex flex-wrap">
                ...
                <div className="flex-1 text-center mb-3 px-2">
                    <p>Winchester Ukrainian Cultural Association</p>
                    <p>&copy; 2024</p>
                </div>
                <div className="flex justify-between md:flex-col flex-auto md:text-right w-full md:flex-1 md:w-auto">
                    <div>
                        <h3>{t('contact_us')}:</h3>
                        <p><a className="text-blue-400" href="mailto:wuca.office@gmail.com">wuca.office@gmail.com</a></p>
                    </div>
                    <div>
                        <h3>{t('follow_us')}:</h3>
                        <a className="inline-flex gap-2 text-blue-400" href="https://www.facebook.com/wuca.official" target="_blank">
